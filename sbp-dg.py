...
def main(write_output=True, order=4):
    ...
    vis = make_visualizer(actx, sbp_bdry_discr, vis_order=order)
    vis.write_vtk_file("Results_Test/bdry_disc.vtu",
                       [], overwrite=True)
    ...
    # Visualize our new boundary discretization
    # from meshmode.discretization.visualization import make_visualizer
    # vis = make_visualizer(queue, std_bdry_discr, vis_order=order)
    # vis.write_vtk_file("Results/std_bdry_disc.vtu",
    #                    [], overwrite=True)
    ...
    for event in dt_stepper.run(t_end=final_time):
        if isinstance(event, dt_stepper.StateComputed):
            ...
            vis.write_vtk_file("Results/dg-%04d.vtu" % step,
            ...
            filename = "Results/sbp_%04d.vts" % step
            import os
